...
public data class ListBean(var shows: ArrayList<PosterBean>?, var movies: ArrayList<PosterBean>?)
...
public data class PlatformsBean(var svods :ArrayList<SvodsBean>)
...
public data class IdMovieBean(var backdrop :String, var title: String, var release_date :String, var platform_links :List<PlatformsShowsBean>, var synopsis :String, var notes :NoteBean, var poster: String)
...
public data class CastingShowsBean(var characters :ArrayList<CharactersBean>)
